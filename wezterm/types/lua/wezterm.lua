...
local wezterm = {
  ...
  ---@overload fun(event_name: 'user-var-changed', callback: fun(window: _.wezterm.Window, pane: _.wezterm.Pane, name: string, value: string): nil): nil
  ...
  ---@overload fun(event_name: CustomEvent, callback: fun(window: _.wezterm.Window, pane: _.wezterm.Pane): nil): nil
